...
if len(outcome_0_rows) >= 500:
    random_selected_rows = outcome_0_rows.sample(n=250, random_state=42)
...
print(f"XGBoost - Accuracy: {voting_accuracy},\n F1 Score: {voting_f1},\n  ROC AUC: {voting_roc_auc}")
...
(voting_accuracy,
 voting_f1,
 voting_roc_auc) = evaluate_model(rf_final, X, y)
print(f"Random Forest - Accuracy: {voting_accuracy},"
      f"\nF1 Score: {voting_f1},"
      f"\nROC AUC: {voting_roc_auc}")
...
important_features = ["Insulin", "Glucose", "Age", "BMI"]
